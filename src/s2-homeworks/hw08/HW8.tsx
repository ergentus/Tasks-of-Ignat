...
import {check18AC, homeWorkReducer, sortUpAndDownAC} from './bll/homeWorkReducer'
...
const HW8 = () => {
    ...
    const sortUp = () => {
        setPeople(homeWorkReducer(initialPeople, sortUpAndDownAC('up')))
        setCurrentSort('up')
    }

    const sortDown = () => {
        setPeople(homeWorkReducer(initialPeople, sortUpAndDownAC('down')))
        setCurrentSort('down')
    }
    const check18 = () => {
